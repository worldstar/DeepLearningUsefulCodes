...
$('#upload-input').change(async function(e){
        ...
        for (var i = 0; i < files.length; i++)
        {
          ...
          console.log(files[0]);
          // $("#upload").attr('src', url);
           $("#upload").append(` <tr ><td width="30%"><img id='salad${files[0].name+i+num}' src=${url}></td width="70%"><td id='sal${files[0].name+i+num}'>預測中...</td></tr>`);
        }
        var str = '';
        ...
        for (var i = 0; i < files.length; i++)
        {
           ...
           if(predictions.length == 0){
            ...
            str = 'not found!!\n';
            document.getElementById(`sal${files[0].name+i+num}`).innerHTML='not found!!\n';
          }else{
            ...
            document.getElementById(`sal${files[0].name+i+num}`).innerHTML ="left:"+myJSON1+"<br> top:"+myJSON11+"<br> width:"+myJSON12+"<br> height:"+myJSON13+"<br> label:"+myJSON2+"<br> score:"+myJSON3;
          }
